...
data class JapaneseQuestion(val prompt: String, val answer: String)

object JapaneseStudyData {
    val hiragana = kanaQuestions(
    ...
    private fun kanaQuestions(source: String): List<JapaneseQuestion> = source.split(' ').map { item ->
